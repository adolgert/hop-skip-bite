...
\begin{eqnarray}
  ...
  &=&N_0^2(N_0K')\frac{1}{N_0}\left[
    \frac{e^{t'}}{K'+(e^{t'}-1)}\right]^2dt' \\
  & = & N_0^2K'\left[\frac{e^{t'}}{K'+e^{t'}-1}\right]^2dt'.
\end{eqnarray}
...
to show that.
\begin{equation}
  \lambda(t)dt =N_0^2K'\left[\frac{e^{t'}}{e^{t'}+(K'-1)}\right]^2dt'
\end{equation}
...
\begin{eqnarray}
  \lambda(t)dt & = & N_0^2K'\left[\frac{u(K'-1)}{(u+1)(K'-1)}\right]^2
      \frac{du}{u} \\
  & = & N_0^2K'\frac{u}{(u+1)^2}du \\
\end{eqnarray}
